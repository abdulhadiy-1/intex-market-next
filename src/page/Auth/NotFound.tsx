...
const NotFound = () => {
  return (
    <div className="h-screen w-full flex flex-col justify-center items-center bg-gradient-to-br bg-[var(--clr-bg)] text-gray-800 animate-fade-in">
      ...
      <p className="text-[24px] sm:text-[20px] mt-4 font-medium">Страница не найдена</p>
